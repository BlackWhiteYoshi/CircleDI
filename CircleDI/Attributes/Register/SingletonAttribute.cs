...
public static partial class Attributes {
    public const string SingletonAttribute = $$"""
        ...
        internal class SingletonAttribute<TService, TImplementation> : Attribute where TImplementation : TService {
            /// <summary>
        ...
        [AttributeUsage(AttributeTargets.Class | AttributeTargets.Struct, AllowMultiple = true)]
        [System.CodeDom.Compiler.GeneratedCodeAttribute("{{NAME}}", "{{VERSION}}")]
        internal sealed class SingletonAttribute<TService> : SingletonAttribute<TService, TService>;

...
public static partial class Attributes {
    /// <summary>
    /// <para>This provides a polyfill for the <see href="https://learn.microsoft.com/en-us/dotnet/api/system.threading.lock">Lock</see> class when using .NET 8, because <see href="https://github.com/Sergio0694/PolySharp">PolySharp</see> does not (yet) implement it.</para>
    /// <para>Note: This must be removed when <see href="https://github.com/Sergio0694/PolySharp">PolySharp</see> also provides an implementation.</para>
    /// </summary>
    public const string LockPolyfill = $$"""
        // <auto-generated/>
        ...
        /// <summary>
        /// Provides a way to get mutual exclusion in regions of code between different threads. A lock may be held by one thread at a time.
        /// </summary>
        /// <remarks>
        ...
        internal sealed class Lock {
            ...
            /// holds the lock.
            /// </summary>
            /// <returns><code>true</code> if the lock was entered, <code>false</code> otherwise.</returns>
            /// <remarks>
            ...
            /// statement.
            /// </summary>
            /// <returns>A <see cref="Scope"/> that may be disposed to exit the lock.</returns>
            /// <remarks>
            /// If the lock cannot be entered immediately, the calling thread waits for the lock to be exited. If the lock is
            ...
            /// </summary>
            public readonly ref struct Scope(Lock lockObject) : IDisposable {
                /// <summary>
                /// Exits the lock.
                /// </summary>
                /// <remarks>
                ...
                /// </remarks>
                /// <exception cref="SynchronizationLockException">The calling thread does not hold the lock.</exception>
                public void Dispose() => lockObject.Exit();
            }
        }

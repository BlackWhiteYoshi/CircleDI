...
public static class CircleDIBuilder {
    extension(ObjectPool<StringBuilder> stringBuilderPool) {
        /// <summary>
        /// Gives a preconfigured <see cref="ObjectPool{StringBuilder}"/> for building class or interface.
        /// </summary>
        /// <returns></returns>
        public static ObjectPool<StringBuilder> CreateDefault() => new DefaultObjectPoolProvider().CreateStringBuilderPool(initialCapacity: 8192, maximumRetainedCapacity: 1024 * 1024);
